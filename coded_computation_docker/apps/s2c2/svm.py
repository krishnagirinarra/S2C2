import json
import numpy as np
from masterServerS2C2 import matrixMulKernelMaster
from masterServerS2C2 import encode_matrix
from masterServerS2C2 import encode_matrix_tp
...
def run(first=False, last=False):
    ...
    if first:
        ...
        X_te = np.loadtxt('/home/zhifeng/apps/s2c2/data/Xtest.mat', dtype=int)
        y_te = np.loadtxt('/home/zhifeng/apps/s2c2/data/ytest.mat', dtype=int)
        y_tr = np.loadtxt('/home/zhifeng/apps/s2c2/data/ytrain.mat', dtype=int)
